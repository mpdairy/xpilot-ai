...
xpilot:
	...
	&& make CC='gcc -fPIC'
	mkdir -p build/bin
	cp build/xpilot-4.5.5/src/client/xpilot build/bin/
	cp build/xpilot-4.5.5/src/mapedit/xp-mapedit build/bin/
	cp build/xpilot-4.5.5/src/replay/xp-replay build/bin/
...
server: xpilot
	...
	cp build/xpilot-4.5.5/src/server/xpilots build/bin

lib: xpilot
	cp src/ai/clientAI.c src/ai/clientAI.h src/ai/defaultAI.c src/ai/paintdataAI.c src/ai/painthudAI.c src/ai/xpilotAI.c src/ai/cAI.c src/ai/cAI.h build/xpilot-4.5.5/src/client
	...
	cp src/ai/cAI.h build/include
	mkdir -p build/lib
	cp build/xpilot-4.5.5/src/client/libcAI.so build/lib
